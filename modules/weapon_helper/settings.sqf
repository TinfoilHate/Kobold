...
[_unit,_type,["rhs_weap_akm"]] call FNC_wephelper;

This will add an AKM and fill the unit's remaining inventory space with magazines for the AKM, randomly selected from all the AKM magazines available.

A more reasonable example is:

[_unit,_type,["rhs_weap_akm","rhs_weap_akms","rhs_acc_dtkakm","rhs_30Rnd_762x39mm_bakelite","rhs_30Rnd_762x39mm"]] call FNC_wephelper;

This will add an AKM or AKMS, the DTK muzzle attachment, and fill the unit's remaining inventory space with a random selection of bakelite and normal magazines.

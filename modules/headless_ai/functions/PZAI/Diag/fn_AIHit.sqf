...
if (_Unit getVariable ["PZAI_GHit",false]) exitWith {};
_Unit setVariable ["PZAI_GHit",true];
_Unit spawn {sleep 30;_this setVariable ["PZAI_GHit",false];};
...
//[_Unit,false,false,false,false] spawn PZAI_fnc_MoveToCover;
